---
layout: default
title: PKM Vocabulary — All terms
permalink: /vocab/browse/all/
description: Every concept and collection in the PKM vocabulary in one alphabetical list, with definitions.
search: true
---

# All terms

Every concept and collection in one alphabetical list, with its definition,
any alternative labels, and the collections it belongs to. Collections are
marked as such; the [hierarchy](../hierarchy/) shows where the concepts sit.

Concepts and collections are listed together on purpose. Four collections are
not named "…Collection" — Tech Stack, Note Types, Meal Domain and Semantic Web
Standards — so scanning A–Z for one of those would otherwise mean already
knowing it was a collection.

<!-- pkm:begin generated -->
<!-- Generated by `make build`. Edits between these markers are overwritten. -->

[A](#a) · [B](#b) · [C](#c) · [D](#d) · [E](#e) · [F](#f) · [G](#g) · [H](#h) · [I](#i) · [K](#k) · [L](#l) · [M](#m) · [N](#n) · [O](#o) · [P](#p) · [Q](#q) · [R](#r) · [S](#s) · [T](#t) · [U](#u) · [V](#v) · [W](#w) · [Y](#y)
...
[Vocabulary home](../../) · [Hierarchy](../hierarchy/) · [Collections](../collections/)
